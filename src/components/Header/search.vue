    ...
    <div class="searchMenu" v-if="showMenu">
      <div class="locationColumn">
        ...
        <div v-if="isActive" class="locationDropDownHolder">
          <div v-for="item in locations" :key="item" class="locationDropDown">
            <span v-on:click="changeLocation(item)" class="particularLocation"
              ><i class="material-icons" style="color: #eb5757">place</i>
